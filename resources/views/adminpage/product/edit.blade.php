              ...
              <div class="card card-info">
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                      ...
                      <input name="nama" value="{{ $product->nama }}" type="text" class="form-control" placeholder="Nama Produk">
                    </div>
                  <!-- /.form group -->
                  <!-- kategori -->
                  <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <option value="{{ $product->merek }}" selected>{{ $product->merek }}</option>
                      </select>
                    </div>
                    <!-- foto produk -->
                    <div class="form-group">
                      ...
                      <div class="input-group">
                        <div class="custom-file">
                          <input type="file" name="Gambar" value="{{ $product->gambar }}" class="custom-file-input" id="exampleInputFile">
                    ...
                    <div class="form-group">
                      ...
                      <textarea name="deskripsi" class="form-control" rows="3" placeholder="Deskripsi">
                      {{ $product->deskripsi }}
                      </textarea>
                    </div>
                    <!-- Harga -->
                    <div class="form-group">
                      <label>Harga</label>
                      <input name="harga" type="number" class="form-control" placeholder="Harga" value="{{ $product->harga }}">
                    </div>
                    <!-- Berat -->
                    <div class="form-group">
                      <label>Berat</label>
                      <input name="berat" type="number" class="form-control" placeholder="Berat" value="{{ $product->berat }}">
                    </div>
                    <!-- Slide -->
                    <div class="card">
                      <div class="card-header">
                      ...
                      <div class="card-body">
                      @if($product->slide=='Y')
                        <input type="checkbox" name="slide" value="Y" data-bootstrap-switch checked>
                      @else
                    ...
                    <div class="card">
                      ...
                      <div class="card-body">
                      @if($product->rekom=='Y')
                        <input type="checkbox" name="rekomend" value="Y" data-bootstrap-switch checked>
                      @else
